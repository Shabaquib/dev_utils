...
class _ChatGPTSheetComponentState extends State<ChatGPTSheetComponent> {
  ...
  void handleGenerateClick(BuildContext context) async {
    if (isLoading ||
      ...
      useToast(widget.gptModuleStrings.pleaseWaitGeneratingContent);
      return;
    }
    if (promptCont.text.isEmpty) {
      useToast(widget.gptModuleStrings.pleaseEnterTextToGenerate);
      return;
    }
            ...
            Row(
              ...
              children: [
                Text(
                  ...
                  style: boldTextStyle(
                    size: 16,
                    color: context.primaryColor.withAlpha(85),
                  ),
                ).expand(),
                            ...
                            if (isTextAnimationCompleted)
                              IconButton(
                                onPressed: () {
                                  ...
                                  useToast(widget.gptModuleStrings.copied);
                        ...
                        children: [
                          ...
                          IconButton(
                            icon: Icon(
                              ...
                              color: context.iconColor.withAlpha(60),
                            ),
                            onPressed: () async {
                              showConfirmDialogCustom(
                                ...
                                primaryColor:
                                    context.primaryColor.withAlpha(85),
